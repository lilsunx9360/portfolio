        ...
        <div className="relative flex items-center justify-center order-2 md:order-2">
          <div className="absolute inset-0 flex items-center justify-center z-0">
            <div className="relative w-full h-full max-w-[400px] max-h-[400px] sm:max-w-[450px] sm:max-h-[450px] md:max-w-[500px] md:max-h-[500px] lg:max-w-[600px] lg:max-h-[600px] aspect-square">
              {/* Top Left Triangle */}
              <div className="absolute top-0 left-0 w-28 h-28 sm:w-36 sm:h-36 border-t-4 border-l-4 border-purple-400 opacity-30 transform -translate-x-6 -translate-y-6 rotate-12"
                style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }} />
              {/* Bottom Right Triangle */}
              <div className="absolute bottom-0 right-0 w-28 h-28 sm:w-36 sm:h-36 border-b-4 border-r-4 border-cyan-400 opacity-30 transform translate-x-6 translate-y-6 -rotate-12"
                style={{ clipPath: 'polygon(100% 100%, 0 100%, 100% 0)' }} />
              {/* Bottom Left Small Triangle */}
              <div className="absolute bottom-0 left-0 w-20 h-20 sm:w-28 sm:h-28 border-b-4 border-l-4 border-pink-400 opacity-30 transform -translate-x-4 translate-y-4 rotate-45"
