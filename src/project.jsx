...
const Project = () => {
  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-screen bg-gradient-to-tr from-black via-black to-neutral-800 text-white overflow-hidden px-4 py-6 sm:py-10">
      ...
      <div className="flex justify-center items-center relative">
        ...
        <div className="w-full max-w-6xl overflow-x-auto no-scrollbar" ref={scrollRef}>
          <div className="flex">
